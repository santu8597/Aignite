...
import { FileUp, Send, X, Loader2, User, Bot, ImagePlus, Sparkles, Copy } from "lucide-react"
          ...
          <div className="relative flex-1">
            ...
            <motion.div >
              <Button
                type="submit"
                size="icon"
                className="absolute right-2 bottom-4 h-8 w-8 bg-primary hover:bg-primary/90"
